sap.ui.define([
	...
	return BaseController.extend("com.sap.training.ux402.templateusage.UX402_UsingTemplateExercise.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.sap.training.ux402.templateusage.UX402_UsingTemplateExercise.view.ViewSettingsDialog",
					controller: this
