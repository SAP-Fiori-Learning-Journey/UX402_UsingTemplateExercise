sap.ui.define([
	"sap/ui/test/Opa5",
	"com/sap/training/ux402/templateusage/UX402_UsingTemplateExercise/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.sap.training.ux402.templateusage.UX402_UsingTemplateExercise.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.sap.training.ux402.templateusage.UX402_UsingTemplateExercise",
					async: true
				},
				hash: oOptions.hash,
